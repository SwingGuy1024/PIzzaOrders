...
```java
 ...
 5
 6      // throws new ResponseException(NOT_FOUND, id.toString()) if menuItem is null 
 7      confirmNotNull(menuItem, id);
 8      return objectMapper.convertValue(menuItem, MenuItemDto.class);
 9    });
10  }
 ```
...
On line 7, we test for null, using the `confirmNotNull()` method.
