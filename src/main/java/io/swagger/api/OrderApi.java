...
public interface OrderApi {
    ...
    ResponseEntity<CreatedResponse> addMenuItemOptionToCustomerOrder(@ApiParam(value = "The id of the customer order", required = true) @PathVariable("customer_order_id") Integer customerOrderId, @ApiParam(value = "The id of Menu Item Option to add", required = true) @PathVariable("menu_option_id") Integer menuOptionId);
    ...
    @RequestMapping(value = "/order/complete/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<CreatedResponse> completeOrder(@ApiParam(value = "The id of the completed order",required=true) @PathVariable("id") Integer id);
    ...
    ResponseEntity<Void> deleteOrder(@ApiParam(value = "The id of the order to delete. Note that this does not mark it complete. Completed orders should not be deleted, but should be marked complete at /order/complete/.",required=true) @PathVariable("id") Integer id);
    ...
    @RequestMapping(value = "/order/{id}",
        produces = { "applicaton/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<CustomerOrderDto> searchForOrder(@ApiParam(value = "id of the order to search for",required=true) @PathVariable("id") Integer id);
